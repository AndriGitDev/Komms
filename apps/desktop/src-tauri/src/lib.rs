...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::unlock,
            commands::restore,
            commands::prepare_authority_migration,
            commands::prepare_authority_reset,
            commands::prepare_legacy_backup_authority_reset,
            commands::migrate_authority,
            commands::reset_authority,
            commands::lock,
            commands::status,
            commands::authority_reset_history,
            commands::device_id,
            commands::linked_devices,
            commands::device_authority_conflicts,
            commands::contact_authority_conflicts,
            commands::device_authority_approval_request,
            commands::approve_device_authority_request,
            commands::accept_device_authority_approval,
            ...
            commands::device_link_approval_request,
            commands::approve_device_link_request,
            commands::accept_device_link_approval,
            commands::complete_device_link,
            commands::export_device_sync,
            commands::import_device_sync,
            commands::format_text,
            commands::address_qr,
            commands::rotate_connect_code,
            commands::retire_legacy_discovery,
            commands::my_bundle,
            ...
            commands::delete_message_request,
            commands::block_message_request,
            commands::calls,
            commands::call_availability,
            commands::start_call,
            commands::answer_call,
            commands::decline_call,
            commands::cancel_call,
            commands::hangup_call,
            commands::send_call_audio,
            commands::take_call_audio,
            ...
            commands::group_invitations,
            commands::accept_group_invitation,
            commands::delete_group_invitation,
            commands::groups,
            commands::group_security,
            commands::upgrade_group_security,
            ...
            commands::set_hints,
            commands::request_rendezvous_refresh,
            commands::set_rendezvous_conversation_active,
            commands::publish,
            commands::export_backup,
            commands::export_account_recovery_authority,
        ])
