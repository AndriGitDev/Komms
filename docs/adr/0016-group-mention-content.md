...
Current `KKR9` backs up ordinary sealed group message bodies as opaque bytes, so no backup
...
- Storage and KKR9 need no content-row migration because exact ordinary bodies are already
