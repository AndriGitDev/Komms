...
Current `KKR8` backs up ordinary sealed group message bodies as opaque bytes, so no backup
...
- Storage and KKR8 need no content-row migration because exact ordinary bodies are already
