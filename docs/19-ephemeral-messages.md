...
`KKR8` is the current backup format. It preserves KKR5's exclusion of active ephemeral history,
...
ordinary export refusal; current `KKR8` restore and legacy archive reset;
