...
**Ledger date:** 2026-08-04

**Release scope:** published Komms 0.4.2 unsigned test Beta; stable-v1
assurance target

**Release source baseline:** [`v0.4.2@5a09190`](https://github.com/AndriGitDev/Komms/tree/5a09190cfef9cfef92703672517bc008b6e8cc1f);
the release-fix branch was merged by
[PR #93](https://github.com/AndriGitDev/Komms/pull/93). A later branch build or
retained workflow artifact is not the published 0.4.2 test set.
...
**0.4.2 hosted validation:** [`v0.4.2`, release run 30938415216](https://github.com/AndriGitDev/Komms/actions/runs/30938415216);
all immutable-source, Linux, macOS, Windows, Android, iOS Simulator,
comparison, and evidence-assembly jobs passed

**Accountable release owner:** Andri (`@AndriGitDev`)

**Stable release decision:** not authorized; all P0 gates remain open

**0.4.2 publication decision:** authorized and completed only as an explicitly
unsigned, pre-production test exception. Production signing, stable-beta, and
stable publication remain unauthorized
...
|---|---|---|---|---|---|
| **P0-01 Honest claims and evidence ledger** | Andri (FND; interim SEC/PROD) | Designed: vocabulary, frozen claim register, and this ledger exist; repository documentation and the companion KommsOrg source now distinguish the public unsigned 0.4.2 test release from production/stable qualification. | **Open.** The website update still requires review and deployment, the repository description remains separately controlled, and no stable release evidence bundle exists. | [Stabilization vocabulary](29-stabilization-program.md#2-evidence-vocabulary); [stable-v1 profile](30-stable-v1-product-profile.md); [0.4.2 release record](54-v0.4.2-unsigned-test-release.md); this ledger; [public-copy follow-up](#4-public-copy-audit) | 2026-08-09 |
...
| **P0-07 Signed and recoverable distribution** | Andri (interim REL/SEC); independent release evaluator: **Unassigned** | **Validation workflow exercised; production credential and external gates open.** The source-controlled policy separates offline release-manifest, Play upload, Google-free Android, iOS, macOS, and Windows roles. Bounded validators enforce artifact-class signing coverage, qualification, aggregate SBOM/dependency integrity, exact/normalized reproduction records, revision-authorized residual risk, safe archives, and complete inventories. The exact `v0.4.2` tag-triggered run completed every native build, controlled Linux comparison, and evidence-assembly job with hosted attestations. The selected files and checksum manifests were then published under an explicit unsigned test-only exception. | **Open.** No production role or offline release-manifest key/recovery copy is enrolled. No production-signed Android, Apple, or Windows artifact, completed manifest signature, store path, named-system install/upgrade/failure/rollback result, externally administered reproduction, or independent release evaluation exists. The controlled Linux build is measurement, not independence; iOS is Simulator-only. The public test exception did not exercise the protected draft/promotion/publication path and closes no signed-distribution or stable gate. | [0.4.2 release record](54-v0.4.2-unsigned-test-release.md); [public 0.4.2 test release](https://github.com/AndriGitDev/Komms/releases/tag/v0.4.2); [validation run 30938415216](https://github.com/AndriGitDev/Komms/actions/runs/30938415216); [release security and recovery](39-release-security-and-recovery.md); [release evidence bundles](40-release-evidence-bundles.md); [release policy](../release/policy-v1.json); [release runbook](25-release-runbook.md) | 2026-08-09 |
...
### 0.4.2 hosted validation and unsigned test publication

On 2026-08-04, annotated tag `v0.4.2` resolved to
`5a09190cfef9cfef92703672517bc008b6e8cc1f`. The tag-triggered
[release run](https://github.com/AndriGitDev/Komms/actions/runs/30938415216)
completed successfully across immutable-source checks, primary and controlled
Linux builds, macOS universal, Windows x86-64, Android packages, the unsigned
iOS Simulator, comparison, and evidence assembly.

The hosted candidate archive had SHA-256
`c25aa8f6f3ac0723c3edd4a1b6c37e36c7feb70fbc1a883efab841ce8a38cb50`;
the hosted evidence artifact had SHA-256
`3ab0f46f99892bfb1eb76fe2abab3ec298c69de533485a4b4e8064e7d2bea87c`.
The evidence verifier accepted all ten inventoried artifacts for the exact
revision. The records remained honestly open: `production_signed: false`,
`qualified_for_stable: false`, and `independently_reproduced: false`, with zero
of six production signing roles verified.

The maintainer then authorized the exact files as a public, explicitly
unsigned pre-production test exception for version 0.4.2 only. The
[`v0.4.2` prerelease](https://github.com/AndriGitDev/Komms/releases/tag/v0.4.2)
contains the selected validation assets, their original checksum/evidence
archive, and a Google-free APK signed with the existing Android test/debug
certificate for physical-device installation. Remote names, sizes, and digests
matched the staged files; the public `UNSIGNED-TEST-SHA256SUMS` also matched a
fresh unauthenticated download byte-for-byte.

This publication does not close P0-07 or any stable gate. No production key,
offline manifest signature, store role, independent reproduction/review,
complete platform qualification, operator qualification, or authenticated
update/rollback path was introduced. The complete immutable boundary is
...
|---|---|---|---|---|---|---|
| **SV1-C01 Distribution** | Supported Komms clients install, update, and recover through authenticated release paths. | Andri (REL/SEC); external release evaluator: **Unassigned** | Public unsigned 0.4.2 test packages plus implemented packaging/evidence controls; no authenticated production update path | [Beta guide](53-beta-testing.md); [0.4.2 release record](54-v0.4.2-unsigned-test-release.md); [public 0.4.2 test release](https://github.com/AndriGitDev/Komms/releases/tag/v0.4.2); [release runbook](25-release-runbook.md) | P0-07 production signing, authenticated updates, rollback, independent reproducibility, and key recovery | 2026-08-09 |
