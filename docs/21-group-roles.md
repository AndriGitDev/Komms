...
`KKR10` carries them forward with linked-device recovery state, while continuing KKR5's terminal ephemeral
...
reorder and C2 owned-device convergence, current `KKR10` restore, RPC/CLI,
